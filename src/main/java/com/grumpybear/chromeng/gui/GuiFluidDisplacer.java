...
public class GuiFluidDisplacer extends GuiContainer{
	
	public GuiFluidDisplacer(IInventory playerInv, TileDisplacer tile) {
		super(new ContainerFluidDisplacer(playerInv, tile));
